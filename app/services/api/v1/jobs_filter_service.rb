...
module Api
  module V1
    class JobsFilterService
      attr_reader :plumber, :start_date, :end_date, :status
      ...
      def plumber_jobs_by_date_range
        plumber.jobs.by_date_range(start_date, end_date)
      end

      def all_jobs_by_date_range
        Job.by_date_range(start_date, end_date)
      end
      ...
      def filtered_jobs
        filtered_jobs = plumber.nil? ? all_jobs_by_date_range : plumber_jobs_by_date_range
